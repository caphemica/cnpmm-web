  ...
  return (
    <div>
      ...
      <Row gutter={[16, 16]}>
        <Col xs={24} sm={12} md={8} lg={6}>
          <Card loading={loading}>
            <Statistic title="Tổng đơn" value={kpis.totalOrders} />
          </Card>
        </Col>
        <Col xs={24} sm={12} md={8} lg={6}>
          <Card loading={loading}>
            <Statistic title="Đơn hoàn tất" value={kpis.completedOrders} />
          </Card>
        </Col>
        <Col xs={24} sm={12} md={8} lg={6}>
          <Card loading={loading}>
            <Statistic title="Đang giao" value={kpis.shippingOrders} />
          </Card>
        </Col>
        <Col xs={24} sm={12} md={8} lg={6}>
          <Card loading={loading}>
            <Statistic title="Đơn mới" value={kpis.newOrders} />
          </Card>
        </Col>
        <Col xs={24}>
          <Card loading={loading}>
            <Statistic
              ...
              value={(kpis.totalRevenue || 0).toLocaleString() + " đ"}
            />
          </Card>
        </Col>
      </Row>
      ...
      <Row gutter={[16, 16]} style={{ marginTop: 16 }}>
        <Col xs={24} lg={14}>
          <Card title="Doanh thu 14 ngày gần nhất" loading={loading}>
            <Line data={revenueData} />
          </Card>
        </Col>
        <Col xs={24} lg={10}>
          <Card title="Top 10 sản phẩm bán chạy" loading={loading}>
